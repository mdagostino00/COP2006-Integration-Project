...
// todo
// compare string objects by using compareTo and comment about how == works with objects
// %,
...
public class Main {
	...
	public static void printStats(Character member) {
		System.out.printf("%s has the following stats:\n"
				...
				+ "Luck: %d\n"
				+ "Gold: %d\n", 
				member.name, member.getLevel(),
				member.getStrength(), member.getPerception(),
				member.getEndurance(), member.getCharisma(), 
				member.getIntelligence(), member.getAgility(), 
 ...
 * evaluated. In Java, operators of equal precedence are evaluated from
 * left to right, starting in the innermost parentheses,
 * in the following order:
 * postfix increment/decrement
 * prefix incre/decrement
